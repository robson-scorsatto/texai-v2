    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-4xl px-6 py-8">
        ...
        {modules.includes("WHATSAPP") && (
          <Card className="mb-6 flex items-center justify-between">
            <div>
              <h2 className="text-sm font-medium text-gray-900">WhatsApp / Automações</h2>
              <p className="text-xs text-gray-500">Templates, lembretes e histórico de mensagens (simulado).</p>
            </div>
            <Link href="/automacoes" className="text-sm font-medium text-gray-900 underline">
              Abrir →
            </Link>
          </Card>
        )}
